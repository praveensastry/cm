...
// Reads in the config and returns a CMConfig struct
func ReadConfig() (*CMConfig, error) {
...
func (c *CMConfig) AddServer() error {
	c.addServerDialog()
...
func (c *CMConfig) DeleteServer() error {
	count := len(c.Servers)
...
func (c *CMConfig) addServerDialog() {
